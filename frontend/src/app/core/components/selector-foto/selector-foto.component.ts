...
export class SelectorFotoComponent implements OnDestroy {
  ...
  // redondeadas (8px) en vez de circular -- para logos/marcas.
  ...
  // facingMode -- funciona en moviles; en equipos con una sola camara el
  // boton no se muestra (hayVariasCamaras).
